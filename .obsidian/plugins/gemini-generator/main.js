...
// src/response-processing/remove-headline-processor.ts
var RemoveHeadlineProcessor = class {
  // = new RegExp('(#)+( )+(Test)(\n)');
  constructor(next) {
...
// src/response-processing/editor-writer.ts
var EditorWriter = class {
  constructor(editor) {
    this.editor = editor;
  }
  reset() {
  }
  process(input, processingSettings) {
...
// src/response-processing/processing-pipeline.ts
var buildPipeline = (settings, editor) => {
...
function buildGenerateNoteCommand(plugin) {
  ...
  return {
    ...
    editorCallback: async (editor) => {
      ...
      const title = (_a = plugin.app.workspace.getActiveFile()) == null ? void 0 : _a.basename;
      if (!title) {
        new import_obsidian.Notice("Could not get filename", 1500);
        return;
      }
      ...
      const settings = { noteTitle: title };
...
var GeminiGeneratorSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian2.Setting(containerEl).setName("Api Key").setDesc("Gemini API key").addText(
...
// src/main.ts
var GeminiGenerator = class extends import_obsidian3.Plugin {
  async onload() {
