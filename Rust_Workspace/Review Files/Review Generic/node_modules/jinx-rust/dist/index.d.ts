...
declare type Node = MissingNode | SourceFile | Shebang | Program | Snippet | Comment | Identifier | Index | LbIdentifier | McIdentifier | Literal | ItemPath | PunctuationToken | DelimGroup | Attribute | DocCommentAttribute | MacroInvocation | MacroRulesDeclaration | MacroDeclaration | MacroRuleDeclaration | MacroInlineRuleDeclaration | MacroGroup | MacroParameterDeclaration | PubSpecifier | ExternSpecifier | ExpressionStatement | UseStatement | NamedImport | AmbientImport | AnonymousImport | DestructuredImport | ExternCrateStatement | ExternBlockDeclaration | TypeAliasDeclaration | ConstVariableDeclaration | StaticVariableDeclaration | LetVariableDeclaration | ModuleDeclaration | FunctionDeclaration | FunctionSelfParameterDeclaration | FunctionParameterDeclaration | FunctionSpread | StructDeclaration | TupleStructDeclaration | StructPropertyDeclaration | TupleStructItemDeclaration | UnionDeclaration | EnumDeclaration | EnumMemberDeclaration | EnumMemberTupleDeclaration | EnumMemberStructDeclaration | TraitDeclaration | AutoTraitDeclaration | TraitAliasDeclaration | ImplDeclaration | NegativeImplDeclaration | ExpressionTypeSelector | ExpressionTypeCast | ExpressionPath | ExpressionAsTypeCast | ReturnExpression | BreakExpression | ContinueExpression | YieldExpression | CallExpression | MemberExpression | AwaitExpression | UnwrapExpression | ParenthesizedExpression | MinusExpression | NotExpression | OrExpression | AndExpression | ReassignmentExpression | UnassignedExpression | OperationExpression | ReassignmentOperationExpression | ComparisonExpression | LetScrutinee | ClosureFunctionExpression | ClosureFunctionParameterDeclaration | BlockExpression | LoopBlockExpression | WhileBlockExpression | ForInBlockExpression | TryBlockExpression | IfBlockExpression | MatchExpression | MatchExpressionCase | RangeLiteral | StructLiteral | StructLiteralProperty | StructLiteralPropertyShorthand | StructLiteralPropertySpread | StructLiteralRestUnassigned | TupleLiteral | ArrayLiteral | SizedArrayLiteral | ReferenceExpression | RawReferenceExpression | DereferenceExpression | BoxExpression | UnionPattern | ParenthesizedPattern | RestPattern | WildcardPattern | PatternVariableDeclaration | StructPattern | StructPatternPropertyDestructured | StructPatternPropertyShorthand | TuplePattern | ArrayPattern | ReferencePattern | BoxPattern | MinusPattern | RangePattern | TypePath | TypeCall | TypeCallNamedArgument | TypeCallNamedBound | LtIdentifier | LtElided | LtStatic | TypeNever | TypeInferred | GenericTypeParameterDeclaration | ConstTypeParameterDeclaration | GenericLtParameterDeclaration | WhereTypeBoundDeclaration | WhereLtBoundDeclaration | TypeTraitBound | TypeDynBounds | TypeImplBounds | TypeFnPointer | TypeFnPointerParameter | TypeFunction | TypeTuple | TypeSizedArray | TypeSlice | TypeReference | TypeDereferenceConst | TypeDereferenceMut | TypeParenthesized;
interface NTMap {
    0: MissingNode;
    1: SourceFile;
    2: Shebang;
...
declare type StatementNode = ExpressionStatement | MacroRulesDeclaration | MacroDeclaration | UseStatement | ExternCrateStatement | ExternBlockDeclaration | ModuleDeclaration | TypeAliasDeclaration | LetVariableDeclaration | ConstVariableDeclaration | StaticVariableDeclaration | FunctionDeclaration | StructDeclaration | TupleStructDeclaration | TraitDeclaration | AutoTraitDeclaration | TraitAliasDeclaration | ImplDeclaration | NegativeImplDeclaration | EnumDeclaration | UnionDeclaration;
declare type ExpressionNode = MacroInvocation | Identifier | Literal | ExpressionPath | ExpressionTypeCast | ExpressionTypeSelector | ExpressionAsTypeCast | ReturnExpression | BreakExpression | ContinueExpression | YieldExpression | CallExpression | MemberExpression | MemberExpression | AwaitExpression | UnwrapExpression | MinusExpression | NotExpression | ClosureFunctionExpression | BlockExpression | LoopBlockExpression | WhileBlockExpression | ForInBlockExpression | TryBlockExpression | IfBlockExpression | MatchExpression | OrExpression<ExpressionNode, ExpressionNode> | AndExpression<ExpressionNode, ExpressionNode> | ReassignmentExpression | OperationExpression | ReassignmentOperationExpression | ComparisonExpression | RangeLiteral | StructLiteral | TupleLiteral | ArrayLiteral | SizedArrayLiteral | ReferenceExpression | RawReferenceExpression | DereferenceExpression | BoxExpression | ParenthesizedExpression<ExpressionNode>;
declare type PatternNode = MacroInvocation | Identifier | Literal | ExpressionPath | ExpressionTypeCast | ExpressionTypeSelector | MinusPattern<Literal> | RangePattern | BlockExpression | PatternVariableDeclaration | StructPattern | TuplePattern | ArrayPattern | RestPattern | WildcardPattern | ReferencePattern | BoxPattern | UnionPattern | ParenthesizedPattern<PatternNode>;
declare type TypeNode = MacroInvocation | Identifier | TypePath | TypeCall | ExpressionTypeSelector | TypeNever | TypeInferred | TypeDynBounds | TypeImplBounds | TypeFnPointer | TypeFunction | TypeSizedArray | TypeSlice | TypeTuple | TypeReference | TypeDereferenceMut | TypeDereferenceConst | TypeParenthesized<TypeNode>;
...
declare type UnaryExpression = NotExpression | MinusExpression | ReferenceExpression | DereferenceExpression | RawReferenceExpression | BoxExpression;
...
declare type FunctionParameterNode = FunctionSelfParameterDeclaration | FunctionParameterDeclaration | ClosureFunctionParameterDeclaration | TypeFnPointerParameter | TypeNode | FunctionSpread;
declare type NodeWithMaybePatternNoUnionBody = LetVariableDeclaration | ConstVariableDeclaration | StaticVariableDeclaration | FunctionParameterDeclaration | ClosureFunctionParameterDeclaration | PatternVariableDeclaration | UnaryPattern;
interface Located {
    loc: Loc;
}
...
declare type ReaOpExpr = typeof TK["+="] | typeof TK["-="] | typeof TK["*="] | typeof TK["/="] | typeof TK["%="] | typeof TK["&="] | typeof TK["|="] | typeof TK["^="] | typeof TK["<<="] | typeof TK[">>="];
declare type OpExpr = typeof TK["+"] | typeof TK["-"] | typeof TK["*"] | typeof TK["/"] | typeof TK["%"] | typeof TK["&"] | typeof TK["|"] | typeof TK["^"] | typeof TK["<<"] | typeof TK[">>"];
...
declare class Loc {
    ...
    protected readonly ownStart?: number;
    ...
    toJSON(): Omit<this, "toJSON" | "url" | "src" | "len" | "isBefore" | "isAfter" | "contains" | "ownContains" | "isBetween" | "getText" | "getOwnText" | "sliceText" | "clone" | "cloneFrom">;
}
...
/** expression?;? */
declare class ExpressionStatement<T extends ExpressionNode | undefined = ExpressionNode | undefined> extends BaseNode<25> implements MaybeExpressionBody, AttributeTarget {
    expression: T;
    semi: boolean;
    attributes?: AttributeOrDocComment[];
}
...
declare class TypeAliasDeclaration extends BaseNode<33> implements Identifiable, DeclarationLike, TypeBoundsConstaint, MaybeTypeExpressionBody, AttributeTarget, PubTarget {
    id: Identifier;
    generics: LocArray<GenericParameterDeclaration, "<>"> | undefined;
    typeBounds: TypeBound[] | undefined;
    whereBounds: LocArray<WhereBoundDeclaration, "None"> | undefined;
...
declare class ConstVariableDeclaration extends BaseNode<34> implements PatternNoUnionBody, TypeAnnotationTarget<TypeNode | missing>, MaybeExpressionBody, AttributeTarget, PubTarget {
    pattern: Identifier;
...
declare class StaticVariableDeclaration extends BaseNode<35> implements PatternNoUnionBody, TypeAnnotationTarget<TypeNode | missing>, MaybeExpressionBody, AttributeTarget, PubTarget {
...
declare class LetVariableDeclaration extends BaseNode<36> implements PatternNoUnionBody, MaybeTypeAnnotationTarget, MaybeExpressionBody, AttributeTarget {
    pattern: PatternNoUnion;
...
declare class FunctionDeclaration extends BaseNode<38> implements Identifiable, FunctionLike, MaybeBlockBody, DeclarationLike, AttributeTarget, PubTarget, ExternTarget, ConstModifier, AsyncModifier, UnsafeModifier {
    id: Identifier;
    generics: LocArray<GenericParameterDeclaration, "<>"> | undefined;
...
declare class FunctionSelfParameterDeclaration extends BaseNode<39> implements RefAble, LtAble, MutAble, MaybeTypeAnnotationTarget, AttributeTarget {
    ref: boolean;
    lt: Lifetime | undefined;
    mut: boolean;
    typeAnnotation: TypeNode | undefined;
...
declare class FunctionParameterDeclaration extends BaseNode<40> implements PatternNoUnionBody, TypeAnnotationTarget<TypeNode | FunctionSpread | missing>, AttributeTarget {
    pattern: PatternNoUnion;
...
/** id: typeAnnotation */
declare class StructPropertyDeclaration extends BaseNode<44> implements Identifiable, TypeAnnotationTarget<TypeNode | missing>, AttributeTarget, PubTarget {
    id: Identifier;
    typeAnnotation: TypeNode | missing;
    attributes?: AttributeOrDocComment[];
    pub?: PubSpecifier;
...
declare class TraitDeclaration extends BaseNode<51> implements Identifiable, BlockBody, DeclarationLike, TypeBoundsConstaint, AttributeTarget, PubTarget, UnsafeModifier {
    id: Identifier;
    generics: LocArray<GenericParameterDeclaration, "<>"> | undefined;
    typeBounds: TypeBound[] | undefined;
    whereBounds: LocArray<WhereBoundDeclaration, "None"> | undefined;
...
declare class TraitAliasDeclaration extends BaseNode<53> implements Identifiable, DeclarationLike, TypeBoundsConstaint, AttributeTarget, PubTarget, UnsafeModifier {
    id: Identifier;
    generics: LocArray<GenericParameterDeclaration, "<>"> | undefined;
    typeBounds: TypeBound[];
    whereBounds: LocArray<WhereBoundDeclaration, "None"> | undefined;
 ...
 */
declare class ImplDeclaration extends BaseNode<54> implements BlockBody, TypeTargetConstraint, DeclarationLike, AttributeTarget, PubTarget, UnsafeModifier {
    generics: LocArray<GenericParameterDeclaration, "<>"> | undefined;
...
/** left || right */
declare class OrExpression<L extends ConditionExpression = ConditionExpression, R extends ConditionExpression = ConditionExpression> extends BaseNode<71> implements LeftRightLike {
    get kind(): "||";
    left: L;
    tk: TK;
    right: R;
...
/** left && right */
declare class AndExpression<L extends ConditionExpression = ConditionExpression, R extends ConditionExpression = ConditionExpression> extends BaseNode<72> implements LeftRightLike {
    get kind(): "&&";
    left: L;
    tk: TK;
    right: R;
...
declare type ConditionExpression = ExpressionNode | LetScrutinee | AndExpression<ConditionExpression, ConditionExpression> | OrExpression<ConditionExpression, ConditionExpression>;
declare type ConditionExpressionXS = ExpressionNodeXS | LetScrutinee | AndExpression<ConditionExpressionXS, ConditionExpressionXS> | OrExpression<ConditionExpressionXS, ConditionExpressionXS>;
/** |...| -> returnType? expression */
declare class ClosureFunctionExpression extends BaseNode<79> implements FunctionLike, ExpressionBody, MoveModifier, StaticModifier, AsyncModifier {
...
/** pattern: typeAnnotation? */
declare class ClosureFunctionParameterDeclaration extends BaseNode<80> implements PatternNoUnionBody, MaybeTypeAnnotationTarget, AttributeTarget {
    pattern: PatternNoUnion;
    typeAnnotation: TypeNode | undefined;
    attributes?: AttributeOrDocComment[];
}
/** label?: { ...body } */
declare class BlockExpression extends BaseNode<81> implements BlockLike, AttributeTarget, AsyncModifier, MoveModifier, UnsafeModifier, ConstModifier {
...
declare type StructProperty = StructLiteralProperty | StructLiteralPropertyShorthand | StructLiteralPropertySpread | StructLiteralRestUnassigned;
/** key: value */
...
declare type TypeCallArgument = Literal | Lifetime | MinusExpression<Literal> | BlockExpression | TypeCallNamedArgument | TypeCallNamedBound | TypeNode;
...
declare class ConstTypeParameterDeclaration extends BaseNode<126> implements Identifiable, TypeAnnotationTarget<TypeNode | missing>, AttributeTarget {
    id: Identifier;
    typeAnnotation: TypeNode | missing;
...
/** (typeExpression) */
declare class TypeParenthesized<T extends TypeNode | TypeTraitBound = TypeNode | TypeTraitBound> extends BaseNode<142> implements TypeExpressionBody<T> {
    typeExpression: T;
}
...
declare function createLocArray<T extends Node, K extends DelimKind>(tk: K, loc: Loc, array?: T[]): LocArray<T, DelimNameMap[K]>;
...
export { AbiTarget, AmbientImport, AndExpression, AnonymousImport, ArrayLike, ArrayLikeNode, ArrayLiteral, ArrayOrTupleLiteral, ArrayPattern, AsyncModifier, AttrSegment, Attribute, AttributeLike, AttributeOrComment, AttributeOrDocComment, AttributeTarget, AutoTraitDeclaration, AwaitExpression, BaseNode, BlockBody, BlockExpression, BlockLike, BoxExpression, BoxPattern, BreakExpression, CallExpression, Callable, ClosureFunctionExpression, ClosureFunctionParameterDeclaration, Comment, CommentLike, CommentOrDocComment, ComparisonExpression, ConditionBody, ConditionExpression, ConditionExpressionXS, ConstModifier, ConstTypeParamDefault, ConstTypeParameterDeclaration, ConstVariableDeclaration, ContinueExpression, DeclarationLike, DeclarationNode, DelimGroup, DelimKind, DelimKindMap, DelimNameMap, Delimited, DelimitedSequence, DereferenceExpression, DestructuredImport, DocCommentAttribute, EnumDeclaration, EnumDeclarationMember, EnumMemberDeclaration, EnumMemberStructDeclaration, EnumMemberTupleDeclaration, ExpressionAsTypeCast, ExpressionBody, ExpressionNamespaceTarget, ExpressionNamespaceTargetNoSelector, ExpressionNode, ExpressionNodeXS, ExpressionPath, ExpressionStatement, ExpressionTypeCast, ExpressionTypeSelector, ExpressionWithBody, ExpressionWithBodyOrCases, ExternBlockDeclaration, ExternCrateStatement, ExternSpecifier, ExternTarget, FG_Map, Feature, FlowControlExpression, ForInBlockExpression, ForLtParametersBody, FunctionDeclaration, FunctionDeclarationParameters, FunctionLike, FunctionLikeNode, FunctionNode, FunctionParameterDeclaration, FunctionParameterNode, FunctionSelfParameterDeclaration, FunctionSpread, GenericArgsTarget, GenericLtParameterDeclaration, GenericParameterDeclaration, GenericTypeParameterDeclaration, HasLtBounds, Identifiable, Identifier, IdentifierLike, IdentifierOrIndex, IdentifierOrItemPath, IfBlockExpression, ImplDeclaration, ImplDeclarationNode, ImplicitReturnAbleNode, ImportNode, Index, ItemPath, LbIdentifier, LeftRightExpression, LeftRightLike, LetScrutinee, LetVariableDeclaration, Lifetime, Literal, LiteralKind, Loc, LocArray, Located, LogicalExpression, LoopBlockExpression, LtAble, LtElided, LtIdentifiable, LtIdentifier, LtStatic, MacroDeclaration, MacroGroup, MacroInlineRuleDeclaration, MacroInvocation, MacroInvokeSegment, MacroMatchSegment, MacroParameterDeclaration, MacroRuleDeclaration, MacroRulesDeclaration, MacroSeparator, MacroTransformSegment, MatchExpression, MatchExpressionCase, MaybeAsyncNode, MaybeBlockBody, MaybeConditionBody, MaybeConstNode, MaybeExpressionBody, MaybeExternNode, MaybeGenericArgsTarget, MaybeGenericsDeclaration, MaybeHasLtBounds, MaybeIdentifiable, MaybeLabelTarget, MaybeMoveNode, MaybeObjectLike, MaybePatternBody, MaybePatternNoUnionBody, MaybePubNode, MaybeReturnTypeConstraint, MaybeStaticNode, MaybeTypeAnnotationTarget, MaybeTypeExpressionBody, MaybeUnsafeNode, MaybeWhereBoundsDeclaration, McIdentifier, MemberExpression, MinusExpression, MinusPattern, MissingNode, ModuleDeclaration, MoveModifier, MutAble, NTMap, NamedImport, NegativeImplDeclaration, Node, NodeType, NodeWithBody, NodeWithBodyNoBody, NodeWithBodyOrCases, NodeWithCondition, NodeWithMaybePatternNoUnionBody, NodeWithSegments, NodeWithTypeBounds, NotExpression, ObjectLike, ObjectNode, OperationExpression, OrExpression, PRCD, ParenthesizedExpression, ParenthesizedNode, ParenthesizedPattern, PathLike, PathNode, PatternBody, PatternNoUnion, PatternNoUnionBody, PatternNoUnionNoRange, PatternNode, PatternVariableDeclaration, PostfixExpression, Program, ProgramLike, PropertyLike, PubSpecifier, PubTarget, PunctuationToken, RangeLike, RangeLiteral, RangeNode, RangePattern, RangePatternBound, RawReferenceExpression, ReassignmentExpression, ReassignmentNode, ReassignmentOperationExpression, RefAble, ReferenceExpression, ReferencePattern, RestPattern, ReturnExpression, ScrutineeExpression, Segment, Shebang, SizeExpressionBody, SizedArrayLiteral, Snippet, SourceFile, StatementNode, StaticModifier, StaticVariableDeclaration, StructDeclaration, StructLiteral, StructLiteralProperty, StructLiteralPropertyShorthand, StructLiteralPropertySpread, StructLiteralRestUnassigned, StructPattern, StructPatternProperty, StructPatternPropertyDestructured, StructPatternPropertyShorthand, StructProperty, StructPropertyDeclaration, TK, TargetsLifetime, TokenNode, TraitAliasDeclaration, TraitDeclaration, TraitDeclarationNode, TryBlockExpression, TupleLike, TupleLiteral, TupleNode, TuplePattern, TupleStructDeclaration, TupleStructItemDeclaration, TyMacroMatch, TypeAliasDeclaration, TypeAnnotationTarget, TypeBound, TypeBoundsConstaint, TypeBoundsStandalone, TypeBoundsStandaloneNode, TypeCall, TypeCallArgument, TypeCallNamedArgument, TypeCallNamedBound, TypeCallable, TypeDereferenceConst, TypeDereferenceMut, TypeDynBounds, TypeExpressionBody, TypeFnPointer, TypeFnPointerParameter, TypeFunction, TypeFunctionNode, TypeImplBounds, TypeInferred, TypeNamespaceTarget, TypeNamespaceTargetNoSelector, TypeNever, TypeNode, TypeParenthesized, TypePath, TypeReference, TypeSizedArray, TypeSlice, TypeTargetConstraint, TypeTraitBound, TypeTuple, UnaryExpression, UnaryPattern, UnaryType, UnassignedExpression, UnionDeclaration, UnionPattern, UnsafeModifier, UnwrapExpression, UseStatement, VariableDeclarationNode, WhereBoundDeclaration, WhereLtBoundDeclaration, WhereTypeBoundDeclaration, WhileBlockExpression, WildcardPattern, YieldExpression, _ExprPathSource, _PathBase, _TypePathSource, __DevonlyObject, missing, index as rs };
