...
__export(ast_exports, {
  ...
  can_have_Attributes: () => can_have_Attributes,
  can_have_InnerAttributes: () => can_have_InnerAttributes,
  can_have_OuterAttributes: () => can_have_OuterAttributes,
  countActualNodeChildren: () => countActualNodeChildren,
  countRawLiteralHashtags: () => countRawLiteralHashtags,
  deleteAttributes: () => deleteAttributes,
  each_childNode: () => each_childNode,
  each_node: () => each_node,
  end: () => end,
  getActualNodeChildren: () => getActualNodeChildren,
  getAstPath: () => getAstPath,
  getBodyOrCases: () => getBodyOrCases,
  getDelimChars: () => getDelimChars,
  getFirstParameter: () => getFirstParameter,
  getLastParameter: () => getLastParameter,
  getLeftMostCondition: () => getLeftMostCondition,
  getMacroName: () => getMacroName,
  getNodeChildren: () => getNodeChildren,
  getOwnChildAstPath: () => getOwnChildAstPath,
  getParameters: () => getParameters,
  getParenthesizedNodeContent: () => getParenthesizedNodeContent,
  ...
  hasInnerAttributes: () => hasInnerAttributes,
  hasItems: () => hasItems,
  hasLetScrutineeCondition: () => hasLetScrutineeCondition,
  hasMethod: () => hasMethod,
  hasOuterAttributes: () => hasOuterAttributes,
  hasOwnStart: () => hasOwnStart,
  hasParameters: () => hasParameters,
  hasProperties: () => hasProperties,
  hasSelfParameter: () => hasSelfParameter,
  hasSemiNoBody: () => hasSemiNoBody,
  hasSemiNoProperties: () => hasSemiNoProperties,
  hasSuffix: () => hasSuffix,
  hasTypeBounds: () => hasTypeBounds,
  includesTK: () => includesTK,
  insertNode: () => insertNode,
  insertNodes: () => insertNodes,
  isInner: () => isInner,
  isOuter: () => isOuter,
  isTK: () => isTK,
  is_AmbientImport: () => is_AmbientImport,
  is_AndExpression: () => is_AndExpression,
  is_AnonymousImport: () => is_AnonymousImport,
  is_ArrayLikeNode: () => is_ArrayLikeNode,
  is_ArrayLiteral: () => is_ArrayLiteral,
  is_ArrayOrTupleLiteral: () => is_ArrayOrTupleLiteral,
  is_ArrayPattern: () => is_ArrayPattern,
  is_Attribute: () => is_Attribute,
  is_AttributeOrComment: () => is_AttributeOrComment,
  is_AttributeOrDocComment: () => is_AttributeOrDocComment,
  is_AutoTraitDeclaration: () => is_AutoTraitDeclaration,
  is_AwaitExpression: () => is_AwaitExpression,
  is_BareTypeTraitBound: () => is_BareTypeTraitBound,
  is_BitwiseOperator: () => is_BitwiseOperator,
  is_BlockCommentKind: () => is_BlockCommentKind,
  is_BlockCommentNode: () => is_BlockCommentNode,
  is_BlockExpression: () => is_BlockExpression,
  is_BoxExpression: () => is_BoxExpression,
  is_BoxPattern: () => is_BoxPattern,
  is_BreakExpression: () => is_BreakExpression,
  is_CallExpression: () => is_CallExpression,
  is_CaseBlock: () => is_CaseBlock,
  is_ClosureBlock: () => is_ClosureBlock,
  is_ClosureFunctionExpression: () => is_ClosureFunctionExpression,
  is_ClosureFunctionParameterDeclaration: () => is_ClosureFunctionParameterDeclaration,
  is_Comment: () => is_Comment,
  is_CommentOrDocComment: () => is_CommentOrDocComment,
  is_ComparisonExpression: () => is_ComparisonExpression,
  is_ConstTypeParameterDeclaration: () => is_ConstTypeParameterDeclaration,
  is_ConstVariableDeclaration: () => is_ConstVariableDeclaration,
  is_ContinueExpression: () => is_ContinueExpression,
  is_DeclarationNode: () => is_DeclarationNode,
  is_DelimGroup: () => is_DelimGroup,
  is_DereferenceExpression: () => is_DereferenceExpression,
  is_DestructuredImport: () => is_DestructuredImport,
  is_DocCommentAttribute: () => is_DocCommentAttribute,
  is_ElseBlock: () => is_ElseBlock,
  is_EnumDeclaration: () => is_EnumDeclaration,
  is_EnumDeclarationMember: () => is_EnumDeclarationMember,
  is_EnumMemberDeclaration: () => is_EnumMemberDeclaration,
  is_EnumMemberStructDeclaration: () => is_EnumMemberStructDeclaration,
  is_EnumMemberTupleDeclaration: () => is_EnumMemberTupleDeclaration,
  is_EqualityOperator: () => is_EqualityOperator,
  is_ExpressionAsTypeCast: () => is_ExpressionAsTypeCast,
  is_ExpressionNamespaceTarget: () => is_ExpressionNamespaceTarget,
  is_ExpressionNamespaceTargetNoSelector: () => is_ExpressionNamespaceTargetNoSelector,
  is_ExpressionNode: () => is_ExpressionNode,
  is_ExpressionPath: () => is_ExpressionPath,
  is_ExpressionStatement: () => is_ExpressionStatement,
  is_ExpressionTypeCast: () => is_ExpressionTypeCast,
  is_ExpressionTypeSelector: () => is_ExpressionTypeSelector,
  is_ExpressionWithBody: () => is_ExpressionWithBody,
  is_ExpressionWithBodyOrCases: () => is_ExpressionWithBodyOrCases,
  is_ExpressionWithBodyOrCases_or_BlockLikeMacroInvocation: () => is_ExpressionWithBodyOrCases_or_BlockLikeMacroInvocation,
  is_ExternBlockDeclaration: () => is_ExternBlockDeclaration,
  is_ExternCrateStatement: () => is_ExternCrateStatement,
  is_ExternSpecifier: () => is_ExternSpecifier,
  is_FlowControlExpression: () => is_FlowControlExpression,
  is_FlowControlMaybeValueExpression: () => is_FlowControlMaybeValueExpression,
  is_ForInBlockExpression: () => is_ForInBlockExpression,
  is_FunctionDeclaration: () => is_FunctionDeclaration,
  is_FunctionLikeNode: () => is_FunctionLikeNode,
  is_FunctionNode: () => is_FunctionNode,
  is_FunctionParameterDeclaration: () => is_FunctionParameterDeclaration,
  is_FunctionParameterNode: () => is_FunctionParameterNode,
  is_FunctionSelfParameterDeclaration: () => is_FunctionSelfParameterDeclaration,
  is_FunctionSpread: () => is_FunctionSpread,
  is_GenericLtParameterDeclaration: () => is_GenericLtParameterDeclaration,
  is_GenericParameterDeclaration: () => is_GenericParameterDeclaration,
  is_GenericTypeParameterDeclaration: () => is_GenericTypeParameterDeclaration,
  is_Identifier: () => is_Identifier,
  is_IdentifierOrIndex: () => is_IdentifierOrIndex,
  is_IdentifierOrItemPath: () => is_IdentifierOrItemPath,
  is_IfBlockExpression: () => is_IfBlockExpression,
  is_ImplDeclaration: () => is_ImplDeclaration,
  is_ImplDeclarationNode: () => is_ImplDeclarationNode,
  is_ImplicitReturnAbleNode: () => is_ImplicitReturnAbleNode,
  is_ImportNode: () => is_ImportNode,
  is_Index: () => is_Index,
  is_ItemPath: () => is_ItemPath,
  is_LargerLesserOperator: () => is_LargerLesserOperator,
  is_LbIdentifier: () => is_LbIdentifier,
  is_LeftRightExpression: () => is_LeftRightExpression,
  is_LetScrutinee: () => is_LetScrutinee,
  is_LetVariableDeclaration: () => is_LetVariableDeclaration,
  is_Lifetime: () => is_Lifetime,
  is_LineCommentKind: () => is_LineCommentKind,
  is_LineCommentNode: () => is_LineCommentNode,
  is_Literal: () => is_Literal,
  is_LiteralBooleanLike: () => is_LiteralBooleanLike,
  is_LiteralNumberLike: () => is_LiteralNumberLike,
  is_LiteralRawStringLike: () => is_LiteralRawStringLike,
  is_LiteralStringLike: () => is_LiteralStringLike,
  is_Loc: () => is_Loc,
  is_LocArray: () => is_LocArray,
  is_Located: () => is_Located,
  is_LogicalExpression: () => is_LogicalExpression,
  is_LoopBlockExpression: () => is_LoopBlockExpression,
  is_LtElided: () => is_LtElided,
  is_LtIdentifier: () => is_LtIdentifier,
  is_LtStatic: () => is_LtStatic,
  is_MacroDeclaration: () => is_MacroDeclaration,
  is_MacroGroup: () => is_MacroGroup,
  is_MacroInlineRuleDeclaration: () => is_MacroInlineRuleDeclaration,
  is_MacroInvocation: () => is_MacroInvocation,
  is_MacroInvocation_BlockLike: () => is_MacroInvocation_BlockLike,
  is_MacroParameterDeclaration: () => is_MacroParameterDeclaration,
  is_MacroRule: () => is_MacroRule,
  is_MacroRuleDeclaration: () => is_MacroRuleDeclaration,
  is_MacroRulesDeclaration: () => is_MacroRulesDeclaration,
  is_MatchExpression: () => is_MatchExpression,
  is_MatchExpressionCase: () => is_MatchExpressionCase,
  is_MaybeAsyncNode: () => is_MaybeAsyncNode,
  is_MaybeExternNode: () => is_MaybeExternNode,
  is_MaybeMoveNode: () => is_MaybeMoveNode,
  is_MaybePubNode: () => is_MaybePubNode,
  is_MaybeStaticNode: () => is_MaybeStaticNode,
  is_MaybeUnsafeNode: () => is_MaybeUnsafeNode,
  is_McIdentifier: () => is_McIdentifier,
  is_MemberExpression: () => is_MemberExpression,
  is_MinusExpression: () => is_MinusExpression,
  is_MinusPattern: () => is_MinusPattern,
  is_MissingNode: () => is_MissingNode,
  is_ModuleDeclaration: () => is_ModuleDeclaration,
  is_NamedImport: () => is_NamedImport,
  is_NegativeImplDeclaration: () => is_NegativeImplDeclaration,
  is_Node: () => is_Node,
  is_NodeWithBody: () => is_NodeWithBody,
  is_NodeWithBodyNoBody: () => is_NodeWithBodyNoBody,
  is_NodeWithBodyOrCases: () => is_NodeWithBodyOrCases,
  is_NodeWithCondition: () => is_NodeWithCondition,
  is_NodeWithMaybePatternNoUnionBody: () => is_NodeWithMaybePatternNoUnionBody,
  is_NodeWithSegments: () => is_NodeWithSegments,
  is_NodeWithTypeBounds: () => is_NodeWithTypeBounds,
  is_NotExpression: () => is_NotExpression,
  is_ObjectNode: () => is_ObjectNode,
  is_OperationExpression: () => is_OperationExpression,
  is_OrExpression: () => is_OrExpression,
  is_ParenthesizedExpression: () => is_ParenthesizedExpression,
  is_ParenthesizedNode: () => is_ParenthesizedNode,
  is_ParenthesizedPattern: () => is_ParenthesizedPattern,
  is_PathNode: () => is_PathNode,
  is_PatternNoUnion: () => is_PatternNoUnion,
  is_PatternNoUnionNoRange: () => is_PatternNoUnionNoRange,
  is_PatternNode: () => is_PatternNode,
  is_PatternVariableDeclaration: () => is_PatternVariableDeclaration,
  is_PostfixExpression: () => is_PostfixExpression,
  is_Program: () => is_Program,
  is_PubSpecifier: () => is_PubSpecifier,
  is_PunctuationToken: () => is_PunctuationToken,
  is_RangeLiteral: () => is_RangeLiteral,
  is_RangeNode: () => is_RangeNode,
  is_RangePattern: () => is_RangePattern,
  is_RangePatternBound: () => is_RangePatternBound,
  is_RawReferenceExpression: () => is_RawReferenceExpression,
  is_ReassignmentExpression: () => is_ReassignmentExpression,
  is_ReassignmentNode: () => is_ReassignmentNode,
  is_ReassignmentOperationExpression: () => is_ReassignmentOperationExpression,
  is_ReferenceExpression: () => is_ReferenceExpression,
  is_ReferencePattern: () => is_ReferencePattern,
  is_RestPattern: () => is_RestPattern,
  is_ReturnExpression: () => is_ReturnExpression,
  is_Shebang: () => is_Shebang,
  is_SizedArrayLiteral: () => is_SizedArrayLiteral,
  is_Snippet: () => is_Snippet,
  is_SourceFile: () => is_SourceFile,
  is_StatementNode: () => is_StatementNode,
  is_StaticVariableDeclaration: () => is_StaticVariableDeclaration,
  is_StructDeclaration: () => is_StructDeclaration,
  is_StructLiteral: () => is_StructLiteral,
  is_StructLiteralProperty: () => is_StructLiteralProperty,
  is_StructLiteralPropertyShorthand: () => is_StructLiteralPropertyShorthand,
  is_StructLiteralPropertySpread: () => is_StructLiteralPropertySpread,
  is_StructLiteralRestUnassigned: () => is_StructLiteralRestUnassigned,
  is_StructPattern: () => is_StructPattern,
  is_StructPatternProperty: () => is_StructPatternProperty,
  is_StructPatternPropertyDestructured: () => is_StructPatternPropertyDestructured,
  is_StructPatternPropertyShorthand: () => is_StructPatternPropertyShorthand,
  is_StructProperty: () => is_StructProperty,
  is_StructPropertyDeclaration: () => is_StructPropertyDeclaration,
  is_TraitAliasDeclaration: () => is_TraitAliasDeclaration,
  is_TraitDeclaration: () => is_TraitDeclaration,
  is_TraitDeclarationNode: () => is_TraitDeclarationNode,
  is_TryBlockExpression: () => is_TryBlockExpression,
  is_TupleLiteral: () => is_TupleLiteral,
  is_TupleNode: () => is_TupleNode,
  is_TuplePattern: () => is_TuplePattern,
  is_TupleStructDeclaration: () => is_TupleStructDeclaration,
  is_TupleStructItemDeclaration: () => is_TupleStructItemDeclaration,
  is_TypeAliasDeclaration: () => is_TypeAliasDeclaration,
  is_TypeBound: () => is_TypeBound,
  is_TypeBoundsStandaloneNode: () => is_TypeBoundsStandaloneNode,
  is_TypeCall: () => is_TypeCall,
  is_TypeCallNamedArgument: () => is_TypeCallNamedArgument,
  is_TypeCallNamedBound: () => is_TypeCallNamedBound,
  is_TypeDereferenceConst: () => is_TypeDereferenceConst,
  is_TypeDereferenceMut: () => is_TypeDereferenceMut,
  is_TypeDynBounds: () => is_TypeDynBounds,
  is_TypeFnPointer: () => is_TypeFnPointer,
  is_TypeFnPointerParameter: () => is_TypeFnPointerParameter,
  is_TypeFunction: () => is_TypeFunction,
  is_TypeFunctionNode: () => is_TypeFunctionNode,
  is_TypeImplBounds: () => is_TypeImplBounds,
  is_TypeInferred: () => is_TypeInferred,
  is_TypeNamespaceTarget: () => is_TypeNamespaceTarget,
  is_TypeNamespaceTargetNoSelector: () => is_TypeNamespaceTargetNoSelector,
  is_TypeNever: () => is_TypeNever,
  is_TypeNode: () => is_TypeNode,
  is_TypeParenthesized: () => is_TypeParenthesized,
  is_TypePath: () => is_TypePath,
  is_TypeReference: () => is_TypeReference,
  is_TypeSizedArray: () => is_TypeSizedArray,
  is_TypeSlice: () => is_TypeSlice,
  is_TypeTraitBound: () => is_TypeTraitBound,
  is_TypeTuple: () => is_TypeTuple,
  is_UnaryExpression: () => is_UnaryExpression,
  is_UnaryPattern: () => is_UnaryPattern,
  is_UnaryType: () => is_UnaryType,
  is_UnassignedExpression: () => is_UnassignedExpression,
  is_UnionDeclaration: () => is_UnionDeclaration,
  is_UnionPattern: () => is_UnionPattern,
  is_UnwrapExpression: () => is_UnwrapExpression,
  is_UseStatement: () => is_UseStatement,
  is_VariableDeclarationNode: () => is_VariableDeclarationNode,
  is_WhereBoundDeclaration: () => is_WhereBoundDeclaration,
  is_WhereLtBoundDeclaration: () => is_WhereLtBoundDeclaration,
  is_WhereTypeBoundDeclaration: () => is_WhereTypeBoundDeclaration,
  is_WhileBlockExpression: () => is_WhileBlockExpression,
  is_WildcardPattern: () => is_WildcardPattern,
  is_YieldExpression: () => is_YieldExpression,
  is_bitshiftOperator: () => is_bitshiftOperator,
  is_multiplicativeOperator: () => is_multiplicativeOperator,
  nisAnyOf: () => nisAnyOf,
  ownStart: () => ownStart,
  reassignNodeProperty: () => reassignNodeProperty,
  setRange: () => setRange,
  setRangeEnd: () => setRangeEnd,
  setRangeStart: () => setRangeStart,
  start: () => start,
  transferAttributes: () => transferAttributes,
  unsafe_setRangeEnd: () => unsafe_setRangeEnd,
  unsafe_setRangeStart: () => unsafe_setRangeStart,
  unsafe_set_nodeType: () => unsafe_set_nodeType
});
...
function saveOwnRangeStart(target) {
